...
export default class Contact extends React.Component {
    ...
    render () {
        ...
        //     e.preventDefault();
        //     console.log("ENCODE", encode({"form-name" : "contact", name, email, message}));
                ...
                <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                    ...
                    <form netlify name="contact" className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                        ...
                        <div className="relative mb-4">
                            ...
                            <input type="text" id="name" name="name" className="w-full bg-gray-800 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" onChange={this.state.name}/>
                        </div>
                        <div className="relative mb-4">
